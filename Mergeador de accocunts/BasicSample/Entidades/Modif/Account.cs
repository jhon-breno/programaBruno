...
namespace SalesforceExtractor.Entidades.Modif
{
    ...
    public class Account : ModifBase
    {
        public Account()
            : base("Account", 0)
        {
        ...
        private ItemEntidade nome = new ItemEntidade(4, (int)DicColuna.col1_7.nombre, "Nome", "NOME", "NE__Name__c");
        private ItemEntidade cep = new ItemEntidade(20, (int)DicColuna.col1_7.cep, "CEP de Cobrança", "CEP", "BillingPostalCode");
        private ItemEntidade telefone1 = new ItemEntidade(8, (int)DicColuna.col1_7.telefone1, "Telefone Principal", "TELEFONE", "MainPhone__c");
        ...
        private ItemEntidade telefone3 = new ItemEntidade(8, (int)DicColuna.col1_7.telefone3, "Telefone Adicional", "TELEFONE", "AdditionalPhone__c");
        private ItemEntidade email = new ItemEntidade(26, (int)DicColuna.col1_7.mail, "E-mail Principal", "E-MAIL", "PrimaryEmail__c");
        private ItemEntidade emailSecundario = new ItemEntidade(26, (int)DicColuna.col1_7.mail, "E-mail Secundario", "E-MAIL", "SecondaryEmail__c");
        private ItemEntidade giro = new ItemEntidade(55, (int)DicColuna.col1_7.giro, "Atividade Econômica", "ATIVIDADE COMERCIAL", "EconomicActivity__c");
        private ItemEntidade nascimento = new ItemEntidade(87, (int)DicColuna.col1_7.fecha_nasc, "Data de Nascimento", "DATA NASCIMENTO", "BirthDate__c");
        private ItemEntidade mae = new ItemEntidade(147, (int)DicColuna.col1_7.apellido_materno, "Nome da Mãe", "ATUALIZACAO NOME DA MAE", "CNT_Mothers_Full_Name__c");
        //private ItemEntidade documentoTipo = new ItemEntidade(7, (int)DicColuna.col1_7.tipo_identidade, "Telefone Principal", "TELEFONE", "MainPhone__c");
        //private ItemEntidade documento = new ItemEntidade(7, (int)DicColuna.col1_7.documento_cliente, "Telefone Principal", "TELEFONE", "MainPhone__c");
        //private ItemEntidade endereco = new ItemEntidade(5, (int)DicColuna.col1_7.direccion, "Endereço de Cobrança", "ENDEREÇO", "BillingAddress");
        //private ItemEntidade origemCliente = new ItemEntidade(405, "Origem da Conta", "CONSUMO FIXO", "AccountSource");
