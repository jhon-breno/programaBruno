...
List<String> caseNumberList = new List<String>{'52895718'};
...
CNT_LastInvoiceOptions__c,CreatedDate,CNT_Quote__c
	from Case where CNT_Contract__r.contractnumber IN: caseNumberList 
	and recordtype.DeveloperName ='CNT_BR_Alta_Contrato' and status !='CNT0008'];
