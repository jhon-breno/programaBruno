...
{
    public class CorteCoelceGrupoADAO : CorteGrupoADAO
    {

        public CorteCoelceGrupoADAO()
            : base(Empresa.CE)
        {
        }
        ...
        public override string gerarSQLObterMotivoDoCorteAtualGA(int numeroCliente)
        {
            ...
            sql.Append(" from GRANDES:cliente c, ");
            ...
            sql.Append(" and co.motivo_corte in ('04','05','06','07','12')");
