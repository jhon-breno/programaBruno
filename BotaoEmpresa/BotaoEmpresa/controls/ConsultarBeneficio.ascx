<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsultarBeneficio.ascx.cs" Inherits="BotaoEmpresa.controls.ConsultarBeneficio" %>
    ...
    <div class="row padding-top-20">
        <div class="col-xs-12 col-md-6 col-md-offset-3">
            <asp:UpdatePanel ID="UpPanelFormGenerico" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <h2 class="text-center">CONSULTAR BENEFÍCIOS</h2>
                    <asp:Panel runat="server" DefaultButton="Consultar">
                        <div class="row">
                            <div class="col-xs-12 grupo-field">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="ValidationEmailRequired" ValidationGroup="Benefic" CssClass="text-error-field" SetFocusOnError="True" Display="Dynamic" ControlToValidate="UC" ErrorMessage="Campo de preenchimento obrigatório"></asp:RequiredFieldValidator>
                            </div>
                        </div>
            ...
            <div class="row row-btn">
                <div class="col-xs-12">
                    <asp:Button runat="server" ID="Consultar" class="btn-base btn-send" OnClientClick="return LimparFormAutoLeitura()" UseSubmitBehavior="True" Text="Consultar" OnClick="Consultar_OnClick" ValidationGroup="Benefic" />
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function LimparFormAutoLeitura() {
        if (!Page_ClientValidate("Benefic")) {
