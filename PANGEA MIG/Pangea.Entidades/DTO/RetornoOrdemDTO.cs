...
{
    [Serializable]
    public class RetornoOrdemDTO
    {
        //Campos Principais
        //public string numero_ordem { get; set; } //teste
        ...
        //Campos Secundários    (necessários?)
        ...
        public char serie_form_venda { get; set; }
        ...
        public char turno_agend { get; set; }
