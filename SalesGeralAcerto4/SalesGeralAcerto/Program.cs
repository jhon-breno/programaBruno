    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (!sr.EndOfStream)
            {
                ...
                //obj.id_sales_pod = "";
                //obj.externalid_pod = linha[0] + (linha[2].Contains("CNPJ") ? "BRAAMAB2B" : "BRAAMAB2C");
                //obj.empresa = "AMPLA";
                //obj.id_sales_asset = "";
                ...
                string doc = linha[0].PadLeft(11, '0');
                   
                if (!ValidaCPF(doc.Right(11)))
                    {
                        doc = linha[0].PadLeft(14, '0');
                        
                        if (!ValidaCNPJ(doc.Right(14)))
                        {
                            obj.externalid_conta = "";
                        }
                        else
                        {
                            obj.externalid_conta = doc.Right(14);
                        }

                    }
                    else
                    {
                        obj.externalid_conta = doc.Right(11);
                    }
                                

            formato.Append(obj.externalid_conta + "\n"); //formato.Append("|");
